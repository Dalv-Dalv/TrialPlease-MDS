...
Command: npx gltfjsx@6.5.3 .\Final_Coutroom.glb --types 
*/
...
export function Model(props: JSX.IntrinsicElements['group']) {
	const { nodes, materials } = useGLTF('/Final_Coutroom.glb') as GLTFResult
	return (
		<group {...props} dispose={null}>
			...
			<mesh geometry={nodes.Gavel_Handle.geometry} material={materials.DarkerWood_Shiny} position={[-0.574, 1.154, -2.197]} rotation={[-0.223, 1.571, 0]}>
				<group position={[-0.258, 0, 0]}>
					<mesh geometry={nodes.Mesh_2.geometry} material={materials.DarkerWood_Shiny} />
					<mesh geometry={nodes.Mesh_3.geometry} material={materials.Gold} />
				</group>
			</mesh>
...
useGLTF.preload('/Final_Coutroom.glb')
