...
Command: npx gltfjsx@6.5.3 .\Final_Test.glb --types 
*/
...
type GLTFResult = GLTF & {
	nodes: {
		...
		High_Chair: THREE.Mesh
		Gavel_StrikingPlatform: THREE.Mesh
		Mesh_1: THREE.Mesh
		Mesh_2: THREE.Mesh
		Lamp_Shade: THREE.Mesh
		Prosecution_Desk001: THREE.Mesh
		Chair001: THREE.Mesh
		Gallery_Seats008: THREE.Mesh
		Gallery_Seats010: THREE.Mesh
		Gallery_Seats011: THREE.Mesh
		...
		Gallery_Seats006: THREE.Mesh
		Gallery_Seats007: THREE.Mesh
	...
	materials: {
		...
		LightPassthrough: THREE.MeshStandardMaterial
...
export function TrialScene(props: JSX.IntrinsicElements['group']) {
	const { nodes, materials } = useGLTF('/models/Final_Test.glb') as unknown as GLTFResult
	...
	useLayoutEffect(() => {
		...
		// DarkerWood: No metalness, high roughness
		materials.DarkerWood.color.set('#3E2723')
		materials.DarkerWood.metalness = 0.0
		materials.DarkerWood.roughness = 0.85
		...
		// LampPost: Dark metal, semi-shiny
		materials.LampPost.color.set('#AAAAAA')
		materials.LampPost.metalness = 0.8
		materials.LampPost.roughness = 0.4
		...
		materials.LightPassthrough.color.set('#E0F7FA')
		materials.LightPassthrough.metalness = 0.1
		materials.LightPassthrough.roughness = 0.1
		// If it's glass, you might also want to make it transparent:
		materials.LightPassthrough.transparent = true
		materials.LightPassthrough.opacity = 0.6
	...
	return (
		<group {...props} dispose={null}>
			...
			<mesh geometry={nodes.Window.geometry} material={materials.LightPassthrough} position={[0.121, 0, -4]} />
			...
			<mesh geometry={nodes.High_Chair.geometry} material={materials.Baked_Furniture} position={[-1.704, 0.504, 3.984]} />
			<mesh geometry={nodes.Gavel_StrikingPlatform.geometry} material={materials.Baked_Furniture} position={[-0.574, 1.209, -1.938]} />

			{/* lamps */}
			<group position={[1.096, 5.269, 0.497]}>
				<mesh geometry={nodes.Mesh_3.geometry} material={materials.DarkerWood} />
				<mesh geometry={nodes.Mesh_4.geometry} material={materials.LampPost} />
				<mesh geometry={nodes.Lamp_Shade.geometry} material={materials.LampShade} position={[0, -0.985, 0]} scale={0.29} />
			</group>
			<group position={[1.096, 5.269, 2.555]}>
				<mesh geometry={nodes.Mesh_3.geometry} material={materials.DarkerWood} />
				<mesh geometry={nodes.Mesh_4.geometry} material={materials.LampPost} />
				<mesh geometry={nodes.Lamp_Shade.geometry} material={materials.LampShade} position={[0, -0.985, 0]} scale={0.29} />
			</group>
			<group position={[1.096, 5.269, 4.613]}>
				<mesh geometry={nodes.Mesh_3.geometry} material={materials.DarkerWood} />
				<mesh geometry={nodes.Mesh_4.geometry} material={materials.LampPost} />
				<mesh geometry={nodes.Lamp_Shade.geometry} material={materials.LampShade} position={[0, -0.985, 0]} scale={0.29} />
			</group>
			<group position={[1.096, 5.269, 6.671]}>
				<mesh geometry={nodes.Mesh_3.geometry} material={materials.DarkerWood} />
				<mesh geometry={nodes.Mesh_4.geometry} material={materials.LampPost} />
				<mesh geometry={nodes.Lamp_Shade.geometry} material={materials.LampShade} position={[0, -0.985, 0]} scale={0.29} />
			</group>
			...
			<mesh geometry={nodes.Prosecution_Desk001.geometry} material={materials.Baked_Furniture} position={[-1.974, 0.086, 3.323]} rotation={[Math.PI, 0, Math.PI]} />
			<mesh geometry={nodes.Chair001.geometry} material={materials.Baked_Furniture} position={[-0.521, 0.608, -0.957]} />
			<mesh geometry={nodes.Gallery_Seats008.geometry} material={materials.Baked_Furniture} position={[-2.411, 0.504, 3.984]} />
			<mesh geometry={nodes.Gallery_Seats010.geometry} material={materials.Baked_Furniture} position={[1.596, 0.504, 3.984]} />
			<mesh geometry={nodes.Gallery_Seats011.geometry} material={materials.Baked_Furniture} position={[2.302, 0.504, 3.984]} />
			<mesh geometry={nodes.Gallery_Seats001.geometry} material={materials.Baked_Furniture} position={[-2.411, 0.504, 7.264]} />
			<mesh geometry={nodes.Gallery_Seats002.geometry} material={materials.Baked_Furniture} position={[-2.411, 0.504, 8.275]} />
			<mesh geometry={nodes.Gallery_Seats003.geometry} material={materials.Baked_Furniture} position={[-2.411, 0.504, 9.287]} />
			<mesh geometry={nodes.Gallery_Seats004.geometry} material={materials.Baked_Furniture} position={[2.411, 0.504, 6.252]} />
			<mesh geometry={nodes.Gallery_Seats005.geometry} material={materials.Baked_Furniture} position={[2.411, 0.504, 7.264]} />
			<mesh geometry={nodes.Gallery_Seats006.geometry} material={materials.Baked_Furniture} position={[2.411, 0.504, 8.275]} />
			<mesh geometry={nodes.Gallery_Seats007.geometry} material={materials.Baked_Furniture} position={[2.411, 0.504, 9.287]} />
...
useGLTF.preload('/models/Final_Test.glb')
